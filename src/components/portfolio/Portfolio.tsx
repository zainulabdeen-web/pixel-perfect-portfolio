...
const services = [
  {
    ...
    description:
      "Professional WordPress websites, business websites, landing pages, redesigns, customizations, and ongoing maintenance.",
  },
  {
    icon: Layout,
    title: "WooCommerce Development",
    description:
      "Professional online stores, product pages, checkout customization, payment integrations, and WooCommerce improvements.",
  },
  {
    icon: Wrench,
    title: "WordPress Bug Fixing & Troubleshooting",
    description:
      "Fix WordPress errors, plugin conflicts, broken layouts, critical errors, 404/500 errors, database issues, login problems, and theme issues.",
  },
  {
    icon: Code2,
    title: "Elementor Development",
    description:
      "Responsive Elementor websites, custom sections, page customization, redesigns, and professional landing pages.",
  },
  {
    icon: Search,
    title: "SEO & Website Optimization",
    description:
      "On-page SEO, technical SEO, website structure improvements, SEO-friendly implementation, and website optimization.",
  },
  {
    icon: Gauge,
    title: "Website Speed & Performance",
    description:
      "Speed optimization, Core Web Vitals improvements, performance troubleshooting, image and asset optimization, and practical website speed improvements.",
  },
];
...
const skillGroups = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Website Performance", value: 92 },
    ],
  },
  {
    title: "Tools",
...
const projects = [
  {
    ...
    desc: "Professional WordPress business website built with a responsive layout, Elementor customization, and a clean user experience.",
    tech: ["WordPress", "Elementor", "PHP"],
  },
  {
    img: p2,
    title: "WooCommerce Online Store",
    desc: "Modern WooCommerce store with product customization, responsive design, and an optimized shopping experience.",
    tech: ["WooCommerce", "WordPress", "Elementor"],
  },
  {
    img: p3,
    title: "WordPress Bug Fixing & Troubleshooting",
    desc: "Technical WordPress troubleshooting covering plugin conflicts, broken layouts, errors, and website functionality issues.",
    tech: ["WordPress", "PHP", "Troubleshooting"],
  },
  {
    img: p4,
    title: "SEO & Website Optimization",
    desc: "Technical and on-page optimization focused on website structure, performance, usability, and search-friendly implementation.",
    tech: ["SEO", "WordPress", "Performance"],
  },
  {
    img: p5,
    title: "Elementor Landing Page",
    desc: "Responsive and conversion-focused landing page designed and developed using Elementor.",
    tech: ["Elementor", "WordPress", "CSS"],
  },
  {
    img: p6,
    title: "WordPress Website Speed Optimization",
    desc: "Performance improvements focused on loading speed, Core Web Vitals, asset optimization, and overall website performance.",
...
const whyItems = [
  ...
  },
  {
    ...
    text: "Professional websites that work smoothly across desktop, tablet, and mobile devices.",
  },
  {
    icon: Wrench,
    title: "Problem Solving",
    text: "I focus on finding the actual cause of technical issues instead of temporary fixes.",
  },
  {
    icon: Gauge,
    title: "Performance Focused",
    text: "I build and optimize websites with usability, speed, and performance in mind.",
  },
  {
    icon: Search,
    title: "SEO Friendly",
    text: "Clean structure and SEO-friendly implementation to support better search visibility.",
  },
  {
    icon: LifeBuoy,
...
const timeline = [
  {
    ...
    text: "Developing, customizing, troubleshooting, and optimizing WordPress and WooCommerce websites. I work with Elementor, PHP, HTML, CSS, and JavaScript to build responsive websites, solve complex WordPress issues, improve performance, and implement custom functionality.",
  },
  {
    year: "2021 — Present",
    title: "Full Stack Web Developer",
    text: "Building responsive web interfaces and custom functionality using modern front-end and back-end technologies, with a strong focus on usability, performance, and maintainable development.",
  },
  {
    year: "2020 — Present",
    title: "Freelance Web Developer",
    text: "Working with businesses and clients on WordPress development, WooCommerce stores, website redesigns, bug fixing, SEO optimization, performance improvements, and ongoing website support.",
  },
];
...
const testimonials = [
  {
    ...
    role: "Client",
    initials: "C1",
    review: "Client review goes here.",
    rating: 5,
  },
  {
    name: "Client Name 2",
        ...
        >
          ...
          <div className="hidden md:block">
            <Button
              asChild
              variant="default"
              className="rounded-full bg-gradient-to-r from-primary to-primary/70 hover:opacity-90 glow-blue"
            >
              <a href="#contact">
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 opacity-40" aria-hidden>
        ...
        <div
          className="absolute top-1/3 -right-24 h-96 w-96 rounded-full bg-secondary/20 blur-3xl animate-pulse-glow"
      ...
      {floatIcons.map(({ Icon, top, left, delay }, i) => (
        ...
        >
          <div
            className="animate-float rounded-2xl glass p-3"
      ...
      >
        <div>
          ...
          >
            <span className="h-2 w-2 rounded-full bg-green-400 animate-pulse" /> Available for
            freelance projects
          </motion.span>
          ...
          >
            WordPress Developer · WooCommerce Developer · Elementor Developer · SEO &amp;
          ...
          >
            <Button
              asChild
              size="lg"
              className="rounded-full bg-gradient-to-r from-primary to-primary/70 text-primary-foreground glow-blue hover:opacity-95"
            >
              <a href="#contact">
                Hire Me <ArrowRight className="ml-1 h-4 w-4" />
              </a>
          ...
          >
            <div className="flex items-center gap-2">
              <Star className="h-4 w-4 fill-secondary text-secondary" /> 5.0 avg rating
            </div>
            <div className="flex items-center gap-2">
              <Briefcase className="h-4 w-4 text-primary" /> 100+ projects delivered
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -top-4 -right-4 hidden rounded-2xl glass-strong p-4 sm:block animate-float-slow"
          ...
          >
            <div className="flex items-center gap-2 text-sm">
              <div className="flex -space-x-2">
                <Avatar
                  name="Ahmed Khan"
                  className="grid h-7 w-7 place-items-center rounded-full border-2 border-background"
                />
                <Avatar
...
function About() {
  return (
    <Section
      id="about"
      eyebrow="About Me"
      title="Building websites that work as good as they look."
    >
      <div className="grid gap-8 lg:grid-cols-3">
        <motion.div {...fadeUp} className="rounded-3xl glass p-8 lg:col-span-2">
          ...
          <p className="text-lg leading-relaxed text-foreground/90">
            I'm <span className="font-semibold text-foreground">Zain Ul Abdeen</span>, a WordPress
            &amp; Full Stack Web Developer with 4+ years of experience building, fixing,
            customizing, and optimizing websites for businesses and online stores.
          </p>
          <p className="mt-4 leading-relaxed text-muted-foreground">
            I specialize in WordPress, WooCommerce, Elementor, website troubleshooting, SEO, and
            performance optimization. I focus on clean development, responsive experiences, clear
            communication, and reliable solutions that help businesses maintain a strong online
            presence.
          </p>
          <div className="mt-6 flex flex-wrap gap-2">
            {["WordPress", "WooCommerce", "Elementor", "Bug Fixing", "SEO", "Performance"].map(
              (t) => (
                <span
                  key={t}
...
function SkillBar({ name, value, delay }: { name: string; value: number; delay: number }) {
  ...
  useEffect(() => {
    if (inView) setTimeout(() => setV(value), delay);
  }, [inView, value, delay]);
  return (
    <div ref={ref}>
      ...
      <Progress
        value={v}
        className="h-2 bg-white/5 [&>div]:bg-gradient-to-r [&>div]:from-primary [&>div]:to-secondary"
      />
    </div>
  );
}
            ...
            <div className="p-6">
              ...
              <div className="mt-5 flex gap-2">
                <Button
                  asChild
                  size="sm"
                  className="rounded-full bg-gradient-to-r from-primary to-primary/70"
                >
                  <a href="#">
                ...
                >
                  <a href="#">
                    <Github className="mr-1 h-3.5 w-3.5" /> Source
                  </a>
                </Button>
              </div>
            </div>
...
function Why() {
  return (
    <Section
      ...
      title="Freelance without the compromises"
          ...
          >
            ...
            <div className="mt-5 flex items-center gap-3 border-t border-white/5 pt-4">
              <Avatar
                name={t.name}
                initials={t.initials}
                className="grid h-11 w-11 place-items-center rounded-full ring-2 ring-primary/30"
              />
              <div>
      ...
      <div className="grid gap-8 lg:grid-cols-5">
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <label htmlFor="cf-email" className="text-xs text-muted-foreground">
                Email
              </label>
              <Input
                id="cf-email"
          ...
          <div className="mt-4">
            <label htmlFor="cf-message" className="text-xs text-muted-foreground">
              Message
            </label>
            <Textarea
              id="cf-message"
    ...
    <footer className="border-t border-white/5 py-10">
      <div className="mx-auto grid max-w-7xl grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-6 sm:flex sm:justify-between">
        <div className="min-w-0 flex items-center gap-2 text-sm">
          <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-gradient-to-br from-primary to-secondary text-primary-foreground text-sm font-bold">
            Z
          </span>
          <div className="min-w-0 text-muted-foreground">
            <div className="truncate">© {new Date().getFullYear()} Zain Ul Abdeen.</div>
            <div className="truncate text-xs">
              {PROFESSIONAL_TITLE} · {CONTACT_EMAIL}
            </div>
          </div>
        </div>
